...
<section class="py-12">
    <div class="max-w-2xl mx-auto px-4 sm:px-6">
        ...
        <form action="{{ route('appeals.citizens.store') }}" method="POST" class="space-y-5 bg-white p-6 sm:p-8 rounded-lg border border-gray-200 shadow-sm">
            @csrf
            <div>
                <label class="block text-sm font-semibold text-[#0b1325] mb-1">ФИО *</label>
